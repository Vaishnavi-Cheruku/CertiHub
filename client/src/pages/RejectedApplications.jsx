...
const RejectedApplications = () => {
  ...
  const fetchApplications = async () => {
    try {
      setLoading(true);
      const response = await axios.get(`http://localhost:4000/api/income-certificates/staff/${staffId}/rejected`, {
      ...
      toast.error('Failed to fetch rejected applications');
      setLoading(false);
    }
  };
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-2xl font-bold mb-6">Rejected Income Certificate Applications</h1>
          ...
          <table className="min-w-full bg-white shadow-md rounded-lg overflow-hidden">
            <thead className="bg-gray-100">
              <tr>
                ...
                <th className="py-3 px-4 text-left">Rejection Date</th>
            ...
            <div className="p-6">
              ...
              <div className="mb-4 p-3 bg-red-100 rounded-lg">
                <p className="text-red-800 font-semibold">
                  Status: Rejected on {new Date(viewApplication.reviewDate).toLocaleDateString()}
                </p>
              </div>
              ...
              {viewApplication.reviewComments && (
                <div className="mb-6">
                  ...
                  <p className="p-3 bg-red-50 rounded border border-red-200">{viewApplication.reviewComments}</p>
                </div>
              )}
